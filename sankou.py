...
class DiaryRegistry:
    ...
    def create_or_update_file(self, file_path, content, message):
        try:
            ...
            self.repo.update_file(
                file_path, commit, content, file_contents.sha, branch="main")
    ...
    def write(self, content):
        ...
        path = self.create_or_update_file(file_path, content, message)
        return path
    ...
    def read_random_file(self) -> str:
        ...
        start_date = datetime.datetime(2023, 3, 18, tzinfo=datetime.timezone(datetime.timedelta(hours=+9), 'JST'))
        ...
        try:
            ...
            print(f"Contents of file {year}/{month:02d}/{month:02d}{day:02d}.md:\n{content}")
            return content, year, month, day
        except Exception as e:
            print(f"Error reading file: {e}")
            print(f"No file found for {year}/{month:02d}/{month:02d}{day:02d}.md")